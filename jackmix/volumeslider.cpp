...
VolumeSlider::VolumeSlider( QString name, float value, Qt::Orientation o, QWidget* p, const char* n ) : QFrame( p,n ), _name( name ) {
	//setFrameStyle( QFrame::Panel|QFrame::Raised );
	//setLineWidth( 1 );
	//setMargin( 5 );
	QBoxLayout *_layout = new QBoxLayout( this, QBoxLayout::TopToBottom/*, 5, 5*/ );
	QFloatSlider *tmp = new QFloatSlider(  value,0,2,0.1,1000,o,this );
